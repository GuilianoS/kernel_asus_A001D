...
int tfa9894_tfa_mtp_write_wrapper(struct tfa2_device *tfa, uint16_t addr, uint16_t mtp_new,
...
static int tfa9873_init(struct tfa2_device *tfa)
{
	...
	case 0x0a73: /* Initial revision ID */
		...
		tfa2_i2c_write_reg(tfa->i2c, 0x52, 0x17d0); //POR=0x57d0
		tfa2_i2c_write_reg(tfa->i2c, 0x56, 0x0011); //POR=0x0019
		tfa2_i2c_write_reg(tfa->i2c, 0x58, 0x0200); //POR=0x0210
		tfa2_i2c_write_reg(tfa->i2c, 0x59, 0x0001); //POR=0x0000
		...
		tfa2_i2c_write_reg(tfa->i2c, 0x6f, 0x00a3); //POR=0x0085
		tfa2_i2c_write_reg(tfa->i2c, 0x70, 0xa3fb); //POR=0x23fb
		tfa2_i2c_write_reg(tfa->i2c, 0x71, 0x007e); //POR=0x107e
		tfa2_i2c_write_reg(tfa->i2c, 0x83, 0x009a); //POR=0x0799
		tfa2_i2c_write_reg(tfa->i2c, 0x84, 0x0211); //POR=0x0011
		tfa2_i2c_write_reg(tfa->i2c, 0x85, 0x0382); //POR=0x0380
...
static int tfa9878_init(struct tfa2_device *tfa)
{
	...
	switch (tfa->rev) {
		...
		case 0x1a78:
			...
			tfa2_i2c_write_reg(tfa->i2c, 0x01, 0x2e18); //POR=0x2e88
			tfa2_i2c_write_reg(tfa->i2c, 0x02, 0x0628); //POR=0x0008
			tfa2_i2c_write_reg(tfa->i2c, 0x04, 0x0241); //POR=0x0340
			tfa2_i2c_write_reg(tfa->i2c, 0x52, 0x587c); //POR=0x57dc
			tfa2_i2c_write_reg(tfa->i2c, 0x61, 0x0183); //POR=0x0a82
			tfa2_i2c_write_reg(tfa->i2c, 0x63, 0x055a); //POR=0x0a9a
			tfa2_i2c_write_reg(tfa->i2c, 0x65, 0x0542); //POR=0x0a82
			tfa2_i2c_write_reg(tfa->i2c, 0x70, 0xb7ff); //POR=0x37ff
			tfa2_i2c_write_reg(tfa->i2c, 0x71, 0x303e); //POR=0x307e
			tfa2_i2c_write_reg(tfa->i2c, 0x83, 0x009a); //POR=0x0799
			tfa2_i2c_write_reg(tfa->i2c, 0x84, 0x0211); //POR=0x0011
			tfa2_i2c_write_reg(tfa->i2c, 0x8c, 0x0210); //POR=0x0010
			tfa2_i2c_write_reg(tfa->i2c, 0xce, 0x2202); //POR=0xa202
			tfa2_i2c_write_reg(tfa->i2c, 0xd5, 0x0000); //POR=0x0100
			/* ----- generated code end   ----- */
			break;
		default:
...
int tfa2_init_mtp_write_wrapper(struct tfa2_device *tfa, uint16_t addr, uint16_t mtp_new,
		int (*mtp_write)(struct tfa2_device *, uint16_t , uint16_t  ))
{
	int rc;
