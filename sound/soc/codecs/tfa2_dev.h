...
*/
void tfaprintf(log_level_t level, int *idx, const char* fmt, ...);
...
typedef enum tfa9xxx_core_bf {
	...
	TFA9XXX_BF_BATS  = 0x1509,
	TFA9XXX_BF_LP1   = 0x6e10,
	TFA9XXX_BF_LNMODE =0x62e1, 
	TFA9XXX_BF_PWMFREQ =0x5900,
...
//	struct tfa_hal_dev *hal;  /* Device HAL plugin handle >>>> moved to i2c_client */
	...
	int (*dsp_init)(struct tfa2_device *tfa, const char *cmd_buf,
	                   size_t cmd_len);
...
int tfa2_init_mtp_write_wrapper(struct tfa2_device *tfa, uint16_t mtp_address, uint16_t mtp_value,
